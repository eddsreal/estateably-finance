...
| _(not triggered)_ SWC build for the api                     | Setup verification 2026-09-22: TS7 `tsc` emits `design:paramtypes` metadata for the Nest + class-validator sample — no fallback needed                                                                                           | Hand-rolled decorator shims rejected; SWC ships inside `@nestjs/cli`, `tsc` (TS7) stays the typechecker.                                                                                                                                                                                                                                                                                                             |
